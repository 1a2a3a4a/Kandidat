...
public class Game implements Parcelable {
    ...
    public void readFromParcel(Parcel in) {
        ...
        Q4= in.readInt();
        Q5= in.readInt();
        User_1= in.readString();
        User_2= in.readString();
       User1_score= in.readInt();
        User2_score= in.readInt();
        Game_status =in.readInt();
        Game_status_string =in.readString();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(Q4);
        dest.writeInt(Q5);
        dest.writeInt(User1_score);
        dest.writeInt(User2_score);
        dest.writeInt(Game_status);
        dest.writeString(User_1);
        dest.writeString(User_2);
        dest.writeString(Game_status_string);
